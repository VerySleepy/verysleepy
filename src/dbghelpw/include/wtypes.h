...
enum tagTYSPEC
	...
	TYSPEC_FILENAME	= ( TYSPEC_PROGID + 1 ) ,
	TYSPEC_PACKAGENAME	= ( TYSPEC_FILENAME + 1 ) ,
	TYSPEC_OBJECTID	= ( TYSPEC_PACKAGENAME + 1 ) 
    } 	TYSPEC;

typedef /* [public] */ struct __MIDL_IWinTypes_0009
    {
    DWORD tyspec;
    /* [switch_type] */ union __MIDL_IWinTypes_0013
        {
        CLSID clsid;
        LPOLESTR pFileExt;
        LPOLESTR pMimeType;
